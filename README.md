...
* Use proxies (you can find an example [here](https://github.com/EdenwareApps/node-ytdl-core/blob/master/example/proxy.js))
...
* Use cookies (you can find an example [here](https://github.com/EdenwareApps/node-ytdl-core/blob/master/example/cookies.js))
